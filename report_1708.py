"""Weekly report for 17.08-23.08.2026 — Week 16.
Data extracted from CSV exports dated 25.08.2026.
"""
...
TAB_NAME = "17.08-23.08"

DIRECT_E20010227 = {"imp": 406, "clicks": 8, "spend": 0.00, "leads": 0, "target": 0}
DIRECT_E17228851 = {"imp": 1047, "clicks": 86, "spend": 11670.63, "leads": 1, "target": 0}
DIRECT_DUNE = {"imp": 0, "clicks": 0, "spend": 0.00, "leads": 0, "target": 0}
DIRECT_PORG = {"imp": 535, "clicks": 33, "spend": 0.00, "leads": 0, "target": 0}
DIRECT_PORG_L2 = {"imp": 32044, "clicks": 895, "spend": 15628.15, "leads": 9, "target": 5}
DIRECT_ACCOUNTS = [DIRECT_E20010227, DIRECT_E17228851, DIRECT_DUNE, DIRECT_PORG, DIRECT_PORG_L2]
DIRECT_TOTALS = {key: sum(account[key] for account in DIRECT_ACCOUNTS) for key in ("imp", "clicks", "spend", "leads", "target")}

ALL_LEADS, ALL_TARGETS = 39, 7
SEO_LEADS, SEO_TARGETS, SEO_VISITS = 0, 0, 79
OTHER_LEADS, OTHER_TARGETS = 29, 2
...
ROWS = [
    ...
    campaign_row("    Стройка / Поиск / Ростов", 1047, 86, 11670.63, 1),
    metric_row("  dune-group", DIRECT_DUNE),
    metric_row("  porg-3uieikjn", DIRECT_PORG),
    campaign_row("    МК // Строительство // СРА (Ф)", 392, 19, 0),
    campaign_row("    МК // Строительство // СРА (Ф+ТГ)", 143, 14, 0),
    metric_row("  porg-l2oigjze", DIRECT_PORG_L2),
    campaign_row("    Товарная кампания remont.dune-group.ru от 19.08.26", 32044, 895, 15628.15, 9, 5),
    [],
    [],
...
BOLD_ROWS = [0, 2, 3, 4, 5, 6, 8, 9, 12, 15, 16]
