...
TAB_NAME = "13.07-19.07"

# === DIRECT TOTALS ===
DIRECT_E20010227 = {"imp": 26303, "clicks": 280, "spend": 57406.19, "leads": 11, "target": 2}
DIRECT_E17228851 = {"imp": 29456, "clicks": 233, "spend": 13849.69, "leads": 0, "target": 0}
DIRECT_DUNE      = {"imp": 0,     "clicks": 0,   "spend": 0.00,     "leads": 0, "target": 0}
DIRECT_PORG      = {"imp": 227,   "clicks": 7,   "spend": 0.00,     "leads": 0, "target": 0}
...
def acc_label(d):
    if d is DIRECT_E20010227: return "e-20010227"
    if d is DIRECT_E17228851: return "e-17228851"
    if d is DIRECT_DUNE: return "dune-group"
    if d is DIRECT_PORG: return "porg-3uieikjn"
    return "?"
...
ROWS = [
    ...
    ["    МК // Строительство // CPA (Ф+ТГ)", 227, 7,
     fmt_pct(safe_div(7, 227) * 100), "—",
     0, "—", "—", 0, "—", "—", "—"],
