...
- porg-3uieikjn: Расход=5931, Клики=120, Показы=0
- e-17228851: Расход=58292, Клики=465, Показы=0
- dune-group: Расход=4707, Клики=151, Показы=0
...
# e-17228851: Расход=58292, Клики=465
# dune-group: Расход=4707, Клики=151, Конв=3.21
# porg-3uieikjn: Расход=5931, Клики=120

# Итого: Расход=96494, Клики=1541, Показы=49416+0+0+0=49416 (только Директ показы)
# Лиды=11, Ц.Лиды=7
...
ROWS = [
    ...
    # Итого
    ["", 49416, 1541, ctr(1541,49416), cpc(96494,1541), 11, "0.71%", "р.8 772", 7, "63.64%", "р.13 785", "р.96 494"],
    # Яндекс Директ
    ["Яндекс Директ", 49416, 1541, ctr(1541,49416), cpc(96494,1541), 11, "0.71%", "р.8 772", 7, "63.64%", "р.13 785", "р.96 494"],
    # e-20010227
    ...
    # e-17228851
    ["e-17228851", "", 465, "", "р.125", 0, "", "", 0, "", "", "р.58 292"],
    ...
    # dune-group
    ["dune-group", "", 151, "", "р.31", 0, "", "", 0, "", "", "р.4 707"],
    ["Кампания dune-group 1", "", 80, "", "", 0, "", "", 0, "", "", ""],
    ["Кампания dune-group 2", "", 71, "", "", 0, "", "", 0, "", "", ""],
    # porg-3uieikjn
    ["porg-3uieikjn", "", 120, "", "р.49", 0, "", "", 0, "", "", "р.5 931"],
