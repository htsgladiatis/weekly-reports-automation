...
# Total all channels:
# leads: 11(Директ)+2(SEO)+0(Рек) = 13
# target: 2(Директ)+1(SEO)+0(Рек) = 3
# CPA total: 29894/13=2300, CPL total: 29894/3=9965
...
ROWS = [
    ...
    # summary: total leads=13, target=3
    # CPA=29894/13=2300, CPL=29894/3=9965
    ["","","","","",13,"","р.2 300",3,"","р.9 965","р.29 894"],
    # Яндекс Директ total
    # leads=11, target=2
