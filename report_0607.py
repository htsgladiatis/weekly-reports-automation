...
# CRM (Bitrix24): leads=34, target=5
# Direct: 11 leads (5 target), all → e-20010227
# SEO: 1 lead (0 target)
...
# CTR = 839/59882 = 1.40%
# CPC = 35776/839 = 43
# CPA_total = 35776/34 = 1052
# CPL_total = 35776/5 = 7155
# Conv→Lead = 34/839 = 4.05%
# Conv→Target = 5/34 = 14.71%
...
ROWS = [
    ...
    # Итого: total leads=34, target=5
    # CPA=35776/34=1052, CPL=35776/5=7155
    ["","","","","",34,"","р.1 052",5,"","р.7 155","р.35 776"],
    # Яндекс Директ: leads=11, target=5
    # CTR=839/59882=1.40%, CPC=35776/839=43,
    # Conv→Lead=11/839=1.31%, CPA=35776/11=3252,
    # Conv→Target=5/11=45.45%, CPL=35776/5=7155
    ["Яндекс Директ",59882,839,"1,40%","р.43",11,"1,31%","р.3 252",5,"45,45%","р.7 155","р.35 776"],
    ...
    # e-17228851: imp=22375, clicks=371, spend=10097, leads=0, target=0
    # CTR=371/22375=1.66%, CPC=10097/371=27
    ["e-17228851",22375,371,"1,66%","р.27",0,"0,00%","-",0,"-","-","р.10 097"],
    # Campaign e-17228851
    ["МК // Ремонт Денис Бренд//",22375,371,"1,66%","р.27",0,"0,00%","-",0,"-","-","р.10 097"],
    # dune-group: imp=0, clicks=0, spend=0
